...
from strategies4btesting import MACD_Strategy, MA_1_0, Bolling_2_0, BaseStrategy, TripleFallenStrategy, SmaCross
...
if __name__ == '__main__':
    ...
    GOOD = pandas.read_csv(join(dirname(__file__), '/Users/acke/Nutstore Files/12.10/backtest/cc.csv'),
                       index_col=0, parse_dates=True, infer_datetime_format=True)


    bt = Backtest(GOOD, SmaCross, commission=.002,
