...
[美棉天气数据分析](./交接文件\供需变量模型\历史分析文件\近期重点\美棉天气数据分析.xlsx)
...
- [相关性测算 包括GDP，纺企，PPI，库存，产销]./Users\dell\Desktop\交接文件\供需变量模型\历史分析文件\近期重点\相关性测算.xlsx) 
## 库销比
...
- [库存消费比](./交接文件\供需变量模型\历史分析文件\近期重点\库存消费比.xlsx)
...
- [供需测算-价格模型](./交接文件\供需变量模型\历史分析文件\近期重点\供需变量-价格测算模型汇总.xlsx)							
## 纺企相关						
1. 行情在低位，有利润，开启主动增库存
2. 通道里不同行情下库存浮动			
...
- [相关性测算 包括GDP，纺企，PPI，库存，产销](./交接文件\供需变量模型\历史分析文件\近期重点\相关性测算.xlsx) 
...
- [农产品周期分析](./交接文件\供需变量模型\历史分析文件\近期重点\农产品周期分析.xlsx)

PTA-原油-橡胶-棉花

1. PTA，原油，橡胶与棉花价格波动呈现高度正相关关系，参考这3种关联性商品的走势对于预判棉花行情有一定程度的指导意义；
2. 当月相关性偏离全年相关性时，最终一定会回归至平均水平，

- [供需变量-价格测算模型汇总](./交接文件\供需变量模型\历史分析文件\近期重点\供需变量-价格测算模型汇总.xlsx)
